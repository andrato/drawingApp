    ...
    describe('When request is successful', () => {
        ...
        describe('When searching for a category with no drawings', () => {
            it('Should return empty array', async () => {
                const response = await request(app).get('/getAdmin').query({category: "a category"});
        ...
        describe('When searching for a category drawings', () => {
            it('Should return the drawings', async () => {
                const response = await request(app).get('/getAdmin').query({category: "topAmateur"});
        ...
        describe('When searching based on date', () => {
            it('Should return the drawings', async () => {
                const response = await request(app).get('/getAdmin').query({startDate: 1685683409490});
        ...
        describe('When sorting based on top rated', () => {
            it('Should return the drawings', async () => {
                const response = await request(app).get('/getAdmin').query({sortBy: "newest"});
